...
| <nobr>`--printenv`</nobr> | Will print the environment content generated from the project environment file (and the project environment base file, if this was defined) and place it in a file at `<project_dir>/secrets/cloud/env.yml`. |
